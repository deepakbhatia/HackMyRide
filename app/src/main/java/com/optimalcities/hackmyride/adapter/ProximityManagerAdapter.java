package com.optimalcities.hackmyride.adapter;
...
import com.optimalcities.hackmyride.ui.activity.SimultaneousScanActivity;
...
public class ProximityManagerAdapter extends ArrayAdapter<SimultaneousScanActivity.ProximityManagerWrapper> {
    ...
    static class ViewHolder {
        ...
        @Bind(R.id.proximity_manager_row_id)
        TextView managerId;

        @Bind(R.id.proximity_manager_row_beacon_count)
        TextView beaconCount;

        @Bind(R.id.proximity_manager_row_distance)
        TextView distance;

        @Bind(R.id.proximity_manager_row_distance_remove)
        Button remove;
